...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        jButton1.addActionListener(ev->adauga());
    ...
    private void adauga(){
        ...
        mc.adaugaProdus(nume, pret);
        afiseazaTaoteProdusele();
    }
    private void afiseazaTaoteProdusele(){
        List<Produs> list = MainController.getInstance().afiseazaToateProdusele();
        model.clear();
