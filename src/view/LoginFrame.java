...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void login(){
        ...
        boolean rez = MainController.getInstance().login(username, parola);
        if(rez == true){
    ...
    private void inregistrare(){
         String username = jTextField1.getText();
        String parola = new String(jPasswordField1.getPassword());
        boolean rez = MainController.getInstance().inregistrare(username, parola);
        if(rez == true){
            JOptionPane.showMessageDialog(null, "inregistrare reusita");
        }else {
            JOptionPane.showMessageDialog(null, "inregistrare nereusita");
        }
    }
